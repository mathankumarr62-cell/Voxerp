...
if os.getenv("VOXERP_ENV", "development").lower() == "production" and (len(SECRET_KEY) < 32 or SECRET_KEY in {"unsafe-development-key-change-me", "replace-with-a-long-random-secret"}):
